...
import { Search, Filter, Pencil, Trash2, X, Plus, RefreshCw } from 'lucide-react';
...
export default function TransactionsPage() {
  ...
  let filteredTotalPoisha = 0n;
  items.forEach((item) => {
    filteredTotalPoisha += BigInt(item.amount_poisha_str);
  });
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-medium bg-white focus:ring-2 focus:ring-slate-900"
            >
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-medium bg-white focus:ring-2 focus:ring-slate-900 capitalize"
            >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 rounded-xl border border-slate-200 text-xs font-medium focus:ring-2 focus:ring-slate-900"
              />
            </div>
          </div>
        </div>
              ...
              <div key={item.id} className="py-3.5 flex items-center justify-between">
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-slate-900 text-sm">{item.description}</span>
